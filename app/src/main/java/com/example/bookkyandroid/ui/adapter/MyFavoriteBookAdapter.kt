...
class MyFavoriteBookAdapter(private val bookData: ArrayList<FavoriteBookDataModel>) : RecyclerView.Adapter<MyFavoriteBookAdapter.PagerViewHolder>() {
