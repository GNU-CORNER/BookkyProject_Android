...
class SearchResultTagListAdapter (private val tags :ArrayList<TagDataResponseDataModel>) : RecyclerView.Adapter<SearchResultTagListAdapter.PagerViewHolder>(){
    ...
    override fun onBindViewHolder(holder:PagerViewHolder,position:Int){
        ...
        holder.itemFrame.setOnClickListener{
            ...
            holder.itemView.findNavController().navigate(R.id.action_global_homeMoreTagDetailFragment,bundle)
        }
    }
